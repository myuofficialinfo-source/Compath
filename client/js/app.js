...
const Lang = {
  ...
  ui: {
    ja: {
      ...
      toolStoreDoctorDesc: 'ストアページの見やすさ等をスコア化します。<br>改善点の洗い出しや調整の指針としてご活用ください。',
    ...
    en: {
      ...
      toolStoreDoctorDesc: 'Score your store page visibility and more.<br>Use it to identify improvements and guide adjustments.',
