...
const Lang = {
  ...
  ui: {
    ja: {
      ...
      toolReviewInsightDesc: 'レビュー要約・分析AI<br>ポジ/ネガを可視化し、改善点を発見',
      toolStoreDoctor: 'ストアページ診断',
      toolStoreDoctorDesc: 'ストアページ診断<br>A/Bテスト候補とベストプラクティスを提案',
      ...
      toolSteamlyticDesc: 'Steamゲーム分析<br>売上推定・競合比較・トレンド追跡',
      tagSales: '売上推定',
      tagCompetitor: '競合比較',
      tagChart: 'チャート',
      tagAI: 'AI分析',
    ...
    en: {
      ...
      toolReviewInsight: 'Steam Review Insight',
      toolReviewInsightDesc: 'Review Summary & Analysis AI<br>Visualize Positive/Negative & Find Improvements',
      toolStoreDoctor: 'Steam Store Doctor',
      toolStoreDoctorDesc: 'Store Page Diagnosis<br>Suggest A/B Test Candidates & Best Practices',
      ...
      toolSteamlyticDesc: 'Steam Game Analysis<br>Sales Estimation, Competitor Comparison, Trend Tracking',
      tagSales: 'Sales Est.',
  ...
  updateHomeUI() {
    ...
    const toolCards = [
      ...
      { id: 'btn-steamlytic', nameKey: 'toolSteamlytic', descKey: 'toolSteamlyticDesc', tags: ['tagSales', 'tagCompetitor', 'tagChart'] }
    ];
